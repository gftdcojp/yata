 ...
 * @returns {string}
 */
export function decode_lance_fragment(file_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(file_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decode_lance_fragment(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @param {string[]} labels
 * @param {string[]} pk_values
 * @param {string[]} repos
 * @param {string[]} rkeys
 * @param {string[]} props_jsons
 * @returns {Uint8Array}
 */
export function encode_vertex_lance(labels, pk_values, repos, rkeys, props_jsons) {
    const ptr0 = passArrayJsValueToWasm0(labels, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(pk_values, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArrayJsValueToWasm0(repos, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passArrayJsValueToWasm0(rkeys, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passArrayJsValueToWasm0(props_jsons, wasm.__wbindgen_malloc);
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.encode_vertex_lance(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {string}
 */
export function read_lance_footer(file_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(file_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.read_lance_footer(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function generate_fragment_path() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.generate_fragment_path();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {Uint8Array}
 */
export function create_manifest(fragment_path, num_rows, field_names, field_ids) {
    const ptr0 = passStringToWasm0(fragment_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(field_names, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray32ToWasm0(field_ids, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.create_manifest(ptr0, len0, num_rows, ptr1, len1, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
export function add_fragment_to_manifest(manifest_file_bytes, fragment_path, num_rows, field_ids) {
    ...
    const ptr2 = passArray32ToWasm0(field_ids, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.add_fragment_to_manifest(ptr0, len0, ptr1, len1, num_rows, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v4 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
export function manifest_path(version) {
    ...
    let deferred1_1;
    try {
        const ret = wasm.manifest_path(version);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function read_manifest(manifest_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(manifest_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.read_manifest(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_getRandomValues_d50a9564033a7f85 = function() { return handleError(function (arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('yata_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
